...
function App() {
  ...
  const {
    ...
    scrollIntoView: () => {},
    onHighlightedIndexChange: ({highlightedIndex}) => highlightedIndex !== -1 && rowVirtualiser.scrollToIndex(highlightedIndex),
  })
    ...
    <div className="city-app">
      ...
      <div>
        ...
        <Menu
          ...
          listRef={listRef}
          virtualRows={rowVirtualiser.virtualItems}
          totalHeight={rowVirtualiser.totalSize}
        />
      </div>
    </div>
  )
